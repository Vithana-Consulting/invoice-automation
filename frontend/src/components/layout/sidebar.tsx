...
const navItems = [
  ...
  { href: '/vendor-mappings', label: 'Vendor Mappings', icon: 'ArrowRightLeft' },
...
const iconMap: Record<string, string> = {
  ...
  GitBranch: 'M6 3v12m0 0a3 3 0 103 3H15a3 3 0 100-3H9m-3 0a3 3 0 01-3-3V6a3 3 0 013-3m12 0a3 3 0 110 6',
  ArrowRightLeft: 'M7.5 21L3 16.5m0 0L7.5 12M3 16.5h13.5m0-13.5L21 7.5m0 0L16.5 12M21 7.5H7.5',
  ...
  Building2: 'M2.25 21h19.5m-18-18v18m10.5-18v18m6-13.5V21M6.75 6.75h.75m-.75 3h.75m-.75 3h.75m3-6h.75m-.75 3h.75m-.75 3h.75M6.75 21v-3.375c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21M3 3h12m-.75 4.5H21m-3.75 3.75h.008v.008h-.008v-.008zm0 3h.008v.008h-.008v-.008zm0 3h.008v.008h-.008v-.008z',
...
export function Sidebar() {
  ...
  return (
    <aside className="w-64 bg-white border-r border-gray-200 min-h-screen">
      <div className="p-6">
        <h1 className="text-xl font-bold text-gray-900">Vithana</h1>
        <p className="text-xs text-gray-500 mt-1">Accounting Platform</p>
      </div>
      <nav className="px-3">
        {navItems.map((item) => (
          <Link
